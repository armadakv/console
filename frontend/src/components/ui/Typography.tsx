...
export const Typography: React.FC<TypographyProps> = ({
  ...
  const variantClasses = {
    ...
    h4: 'text-xl font-bold text-slate-100',
    h5: 'text-lg font-semibold text-slate-100',
    h6: 'text-base font-semibold text-slate-100',
    subtitle1: 'text-base font-medium text-slate-300',
    subtitle2: 'text-sm font-medium text-slate-400',
    body1: 'text-base text-slate-100',

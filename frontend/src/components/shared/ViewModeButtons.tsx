...
export const ViewModeButtons: React.FC<ViewModeButtonsProps> = ({
  ...
  return (
    <div
      className={`flex rounded border border-slate-700 overflow-hidden flex-shrink-0 ${className}`}
    >
      <Button
      ...
      <Button
        ...
        className="rounded-none border-0 border-r border-slate-700 px-2 py-1 h-6 text-xs disabled:opacity-50 disabled:cursor-not-allowed"
      >
